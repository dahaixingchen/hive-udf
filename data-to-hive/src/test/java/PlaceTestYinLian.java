 ...
 * @Version 1.0
 **/
public class PlaceTestYinLian implements TransformFile {
    private static org.apache.log4j.Logger logger = Logger.getLogger(PlaceTestYinLian.class);
    ...
    public PlaceTestYinLian(String inputFloderPath, String inputFileName, String targetTableName,List<Map<String, Integer>> hiveColumns) {
